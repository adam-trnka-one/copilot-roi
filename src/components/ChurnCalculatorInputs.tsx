      ...
      <CardContent className="space-y-6">
        <div className="calculator-input">
          ...
          <div className="flex items-center gap-4">
            ...
            <Input type="number" value={customerCount} min={CUSTOMER_STEPS[0]} max={20000} step="100" onChange={e => handleCustomerCountInputChange(setCustomerCount, e.target.value)} className="w-20" />
          </div>
        </div>
